...
//
//   node docs/design/verification/check-behaviour.mjs            compare HEAD tree to merge base
//   node docs/design/verification/check-behaviour.mjs --verbose  list every differing entry
