...
// Antigravity flags a system prompt that brands the request as a competing client
// and answers 429 Quota Exhausted. Rewrite OpenCode's name, preserving its casing.
const OPENCODE_BRAND_RE = /opencode/gi;
export const rewriteAntigravityBranding = (text) =>
  text.replace(OPENCODE_BRAND_RE, (m) => (m === "OpenCode" ? "Antigravity" : m === "OPENCODE" ? "ANTIGRAVITY" : "antigravity"));
