export default {
  ...
  embeddingConfig: {
    baseUrl: 'https://api.cloudflare.com/client/v4/accounts/{accountId}/ai/v1/embeddings',
    authType: 'apikey',
    authHeader: 'bearer',
    models: [
      { id: '@cf/baai/bge-base-en-v1.5', name: 'BGE Base EN v1.5', dimensions: 768 },
      { id: '@cf/baai/bge-large-en-v1.5', name: 'BGE Large EN v1.5', dimensions: 1024 },
