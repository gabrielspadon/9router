          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <button
                ...
                className="focus-ring w-full sm:w-auto h-14 px-10 rounded-lg border border-border hover:bg-surface text-text-main text-lg font-bold transition-colors duration-150"
              >
                Read Documentation
              </button>
            </div>
