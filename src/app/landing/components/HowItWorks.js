    ...
    <section className="py-24 border-y border-border bg-surface/30" id="how-it-works">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {/* Connection line */}
          <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-[2px] bg-linear-to-r from-border via-brand-500 to-border -z-10"></div>
          
          {/* Step 1: CLI & SDKs */}
          <div className="flex flex-col gap-6 relative group">
            <div className="w-24 h-24 rounded-2xl bg-bg border border-border flex items-center justify-center shadow-soft group-hover:border-brand-500/40 transition-colors duration-150 z-10 mx-auto md:mx-0">
          ...
          <div className="flex flex-col gap-6 relative group md:items-center md:text-center">
            <div className="w-24 h-24 rounded-2xl bg-bg border-2 border-brand-500 flex items-center justify-center shadow-soft z-10 mx-auto">
              <span className="material-symbols-outlined text-4xl text-brand" aria-hidden="true">hub</span>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-2 text-brand">2. 9Router Hub</h3>
              <p className="text-sm text-text-muted">
