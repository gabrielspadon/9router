...
export default function GetStarted() {
  ...
  return (
    <section className="py-24 px-5.5 bg-bg-alt">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          {/* Left: Steps */}
          <div className="flex-1">
            <h2 className="text-3xl md:text-4xl font-bold mb-5.5">Get Started in 30 Seconds</h2>
            <p className="text-text-muted text-lg mb-8">
              Install TokenProxy, configure your providers via web dashboard, and start routing AI requests.
            </p>
            ...
            <div className="flex flex-col gap-5.5">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-lg">Install TokenProxy</h4>
          ...
          <div className="flex-1 w-full">
            <div className="rounded-xl overflow-hidden bg-surface border border-border">
              ...
              {/* Terminal content. ml-2/ml-auto/text-left inside this mock stay
                  physical: a shell transcript reads LTR in every locale. */}
              {/* Terminal content */}
              <div className="p-5.5 font-mono text-sm leading-relaxed overflow-x-auto">
                <button
                  type="button"
                  className="focus-ring hit-44 rounded w-full text-left flex items-center gap-2 mb-4 group cursor-pointer"
                  aria-label="Copy npx tokenproxy to the clipboard"
                  onClick={() => handleCopy("npx tokenproxy")}
                >
                  <span className="text-text-muted" aria-hidden="true">$</span>
                  <span className="text-text-main">npx tokenproxy</span>
                ...
                <div className="text-text-muted mb-5.5">
                  <span className="text-brand" aria-hidden="true">&gt;</span> Starting TokenProxy...<br/>
                ...
                <div className="text-text-muted text-xs">
                  ...
                  <span className="text-text-muted">  macOS/Linux:</span> ~/.tokenproxy/db/data.sqlite<br/>
                  <span className="text-text-muted">  Windows:</span> %APPDATA%/tokenproxy/db/data.sqlite
                </div>
              </div>
            </div>
          </div>
