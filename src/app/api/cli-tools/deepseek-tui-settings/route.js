...
const PROVIDER_NAME = "tokenproxy";
...
// Build TOML config for TokenProxy (openai provider mode)
const buildTokenProxyConfig = (baseUrl, apiKey, model) => {
...
// Detect TokenProxy by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildTokenProxyConfig(baseUrl, apiKey || "sk_tokenproxy", model);
