      ...
      <div className="relative w-full min-w-0">
        ...
        {value && (
          <Button
            ...
            type="button"
            onClick={() => onChange("")}
            aria-label="Clear (inherit main model for subagents)" className="absolute right-1 top-1/2 -translate-y-1/2 text-text-muted hover:text-danger"
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="my-1 border-t border-border pt-3">
                  <div className="mb-2 flex items-start gap-2">
                    <span className="material-symbols-outlined text-brand text-[16px]">account_tree</span>
                    <div>
