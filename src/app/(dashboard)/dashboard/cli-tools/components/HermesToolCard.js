          ...
          {!checking && hermesStatus && !hermesStatus.installed && (
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-3 p-4 bg-warning-soft border border-warning-line rounded-lg">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 ps-0 sm:ps-8">
          ...
          {!checking && hermesStatus?.installed && (
            <>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <Button variant="secondary" size="sm" icon="restore" onClick={handleReset} disabled={!hermesStatus?.hasTokenProxy} loading={restoring} className="w-full sm:w-auto">Reset</Button>
