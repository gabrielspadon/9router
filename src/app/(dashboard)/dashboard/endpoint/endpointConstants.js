...
export const CAVEMAN_LEVELS = [
  ...
  { id: "wenyan-lite", label: "Wenyan Lite", desc: "Classical Chinese, light compression", wenyan: true },
  { id: "wenyan", label: "Wenyan Full", desc: "Maximum Classical Chinese, 80-90% reduction", wenyan: true },
  { id: "wenyan-ultra", label: "Wenyan Ultra", desc: "Extreme classical compression", wenyan: true },
];
