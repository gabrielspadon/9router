        ...
        <Row label="Endpoint">
          <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
            <input
              ...
              className="w-full min-w-0 flex-1 px-3 py-1.5 text-sm border border-border rounded-[var(--radius-brand)] bg-surface-2 text-text-main focus-ring focus:outline-none font-mono"
