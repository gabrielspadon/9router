        ...
        <Row label="Audio File">
          <div className="flex flex-col gap-2">
            <input
              ...
              className="focus-ring w-full text-xs text-text-muted file:me-2 file:py-1 file:px-3 file:rounded-[var(--radius-brand)] file:border file:border-border file:bg-surface-2 file:text-text-main hover:file:bg-surface-3 file:cursor-pointer"
            />
            {audioFile && (
