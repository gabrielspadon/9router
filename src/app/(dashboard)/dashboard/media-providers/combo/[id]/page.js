  ...
  return (
    <div className="flex flex-col gap-5.5">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3 min-w-0">
          <Link href={backHref} aria-label="Back" className="focus-ring rounded-sm text-text-muted hover:text-brand transition-colors duration-150">
            <span className="material-symbols-outlined dir-icon" aria-hidden="true">arrow_back</span>
          </Link>
      ...
      <Card>
        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <p className="text-xs text-text-muted mt-1">Only letters, numbers, -, _ and .</p>
          </div>
          <div className="flex items-center justify-between">
            ...
            <Toggle
              ...
              ariaLabel="Rotate providers across requests instead of strict fallback"
            />
          </div>
        </div>
      </Card>
      ...
      <Card>
        ...
        {providers.length === 0 ? (
          <div className="text-center py-5.5 border border-dashed border-border rounded-[var(--radius-brand)] text-text-muted text-sm">
            No providers yet.
          </div>
        ) : (
