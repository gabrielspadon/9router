      ...
      <div className="flex items-center justify-between mb-2">
        ...
        {meta && (
          <div className="flex min-w-0 items-center gap-2 flex-wrap justify-end">
            ...
            <span className="material-symbols-outlined text-text-muted text-[14px]" aria-hidden="true">arrow_forward</span>
...
function MetaBadge({ label, value }) {
  return (
    <span className="inline-flex min-w-0 items-center gap-1 px-2 py-0.5 rounded-[var(--radius-brand)] border border-border bg-surface-2 text-xs font-mono text-text-main">
