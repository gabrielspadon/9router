      ...
      <div className="flex flex-col gap-4">
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border hover:border-brand-solid hover:bg-brand-soft transition-colors text-start"
              >
                <span aria-hidden="true" className="material-symbols-outlined text-2xl text-brand">lock_open</span>
                <div>
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border hover:border-brand-solid hover:bg-brand-soft transition-colors text-start"
              >
                <span aria-hidden="true" className="material-symbols-outlined text-2xl text-brand">key</span>
                <div>
        ...
        {mode === "oauth" && (
          <>
            <p className="text-xs text-text-muted">
              ...
              <a href={`${baseUrl.trim() || GITLAB_COM}/-/profile/applications`} target="_blank" rel="noreferrer" className="text-brand underline">
                GitLab Applications
              </a>{" "}
              with redirect URI{" "}
        ...
        {mode === "pat" && (
          <>
            <p className="text-xs text-text-muted">
              Create a PAT at{" "}
              <a href={`${baseUrl.trim() || GITLAB_COM}/-/user_settings/personal_access_tokens`} target="_blank" rel="noreferrer" className="text-brand underline">
