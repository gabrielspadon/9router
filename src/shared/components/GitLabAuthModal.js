          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border hover:border-brand-solid hover:bg-brand-soft transition-colors text-left"
              >
                <span className="material-symbols-outlined text-2xl text-brand">lock_open</span>
                <div>
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border hover:border-brand-solid hover:bg-brand-soft transition-colors text-left"
              >
                <span className="material-symbols-outlined text-2xl text-brand">key</span>
                <div>
