    ...
    <Modal isOpen={isOpen} title="Connect Kiro" onClose={onClose} size="lg">
      <div className="flex flex-col gap-4">
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-start gap-3">
                <span aria-hidden="true" className="material-symbols-outlined text-brand mt-1">shield</span>
            ...
            >
              <div className="flex items-start gap-3">
                <span aria-hidden="true" className="material-symbols-outlined text-brand mt-1">business</span>
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <span aria-hidden="true" className="material-symbols-outlined text-brand mt-1">key</span>
                <div className="flex-1">
            ...
            <button
              ...
              className="hidden w-full p-4 text-start border border-border rounded-lg hover:bg-sidebar transition-colors"
            >
              <div className="flex items-start gap-3">
                <span aria-hidden="true" className="material-symbols-outlined text-brand mt-1">account_circle</span>
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <span aria-hidden="true" className="material-symbols-outlined text-brand mt-1">code</span>
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <span aria-hidden="true" className="material-symbols-outlined text-brand mt-1">file_upload</span>
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <span aria-hidden="true" className="material-symbols-outlined text-brand mt-1">data_object</span>
                <div className="flex-1">
        ...
        {selectedMethod === "social-google" && (
          <div className="space-y-4">
            <div className="bg-warning-soft p-4 rounded-lg border border-warning-line">
              <div className="flex gap-2">
