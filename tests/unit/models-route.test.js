...
vi.mock("@/shared/constants/providers", () => ({
  ...
  FREE_PROVIDERS: {},
  FREE_TIER_PROVIDERS: {},
  // Mirrors the real module: buildModelsList seeds credential-free providers
  // into the per-provider loop, and a partial mock without this export would
  // make that loop iterate `undefined` (#2702).
