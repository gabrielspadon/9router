...
beforeEach(() => {
  ...
  // resolvePinnedIps calls lookup(host, { all: true }), which resolves to an
  // ARRAY of records. Returning a bare object left records.length undefined, so
  // resolvePinnedIps returned null and EVERY case below fell out at that same
  // early return -- the SSRF cases passed without ever reaching isPrivateIp.
