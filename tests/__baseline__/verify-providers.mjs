...
// executor: removed dead field (zenmux-free) — dispatch is by provider id through getExecutor(), which resolves
//   "zenmux-free" from the executors registry; nothing ever read transport.executor
const ADDED_FIELDS = new Set(["forceStream", "urlSuffix", "retry", "quirks", "auth", "validateUrl", "usage", "clientId", "clientSecret", "tokenUrl", "cliVersion", "apiClient", "copilot", "authorizeUrl", "authUrl", "regions", "defaultRegion", "reasoningInject", "priority", "hasFree", "executor"]);
